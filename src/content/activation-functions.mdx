...
Why is non-linearity necessary? Without it, we can only represent linear functions. A linear function of two inputs $x_1$ and $x_2$ looks like:
...
Linear functions are quite limited. Here are some things that they cannot do:
